#Written by Hayden Schroeder WUFR22
#Edited by Chris Donnell WUFR22
...
def no_CAN():
    left_display.fill(0)
    left_display.print("---P")
    left_display.set_digit_raw(3,0b01110011)
    left_display.show()

    right_display.fill(0)
    right_display.print("E3--")
    right_display.show()
