 ...
 * CAN DBC C-Headers
 *
 * These headers were generated by dbc2c.awk on Sun May  5 01:06:36 CDT 2019.
 *
...
/**
 * @defgroup DB_stdin CAN Database stdin
 *
 * Path to file: /dev/stdin
 *
 ...
 *
 * This ECU was defined in \ref DB_stdin.
 *
 * TX messages:
 * - \ref MSG_AEMEngine3
 * - \ref MSG_AEMEngine2
 ...
 *
 * TX messages:
 * - \ref MSG_DataLoggerBoard1
 * - \ref MSG_DataLoggerBoard2
 *
 * RX signals:
 *
 * @ingroup DB_stdin
...
/**
 * @defgroup MSG_DataLoggerBoard1 Message DataLoggerBoard1 (0x1f0a006)
 *
 ...
 *
 * Contains signals:
 * - \ref SIG_DataLoggerBoard1_BrakePressureRear
 * - \ref SIG_DataLoggerBoard1_BrakePressureFront
 * - \ref SIG_DataLoggerBoard1_CGGyroscope
 * - \ref SIG_DataLoggerBoard1_CGAccelRawX
 * - \ref SIG_DataLoggerBoard1_CGAccelRawY
 * - \ref SIG_DataLoggerBoard1_CGAccelRawZ
 *
...
/**
 * Message DataLoggerBoard1 configuration tuple.
 */
#define MSG_DataLoggerBoard1                        0x1f0a006, 1, 8

/**
 * Message DataLoggerBoard1 id.
 */
#define ID_DataLoggerBoard1                         0x1f0a006

/**
 * Message DataLoggerBoard1 extended id bit.
 */
#define EXT_DataLoggerBoard1                        1

/**
 * Message DataLoggerBoard1 Data Length Count.
 */
#define DLC_DataLoggerBoard1                        8

/**
 * Message DataLoggerBoard1 cycle time.
 */
#define CYCLE_DataLoggerBoard1                      50

/**
 * Message DataLoggerBoard1 fast cycle time.
 */
#define FAST_DataLoggerBoard1                       0

/**
 * Initialise message DataLoggerBoard1 buffer.
 *
 * @param buf
 *	The can message buffer to initialise
 */
#define INIT_DataLoggerBoard1(buf) { \
	INITSIG_DataLoggerBoard1_BrakePressureRear(buf); \
	INITSIG_DataLoggerBoard1_BrakePressureFront(buf); \
	INITSIG_DataLoggerBoard1_CGGyroscope(buf); \
	INITSIG_DataLoggerBoard1_CGAccelRawX(buf); \
	INITSIG_DataLoggerBoard1_CGAccelRawY(buf); \
	INITSIG_DataLoggerBoard1_CGAccelRawZ(buf); \
}
...
/**
 * @defgroup MSG_DataLoggerBoard2 Message DataLoggerBoard2 (0x1f0a007)
 *
 * Sent by \ref ECU_DATALOGGER_19.
 *
 * Contains signal groups:
 *
 * Contains signals:
 * - \ref SIG_DataLoggerBoard2_WheelSpeed1
 * - \ref SIG_DataLoggerBoard2_WheelSpeed2
 * - \ref SIG_DataLoggerBoard2_BrakeTemp
 *
 * @ingroup ECU_DATALOGGER_19
 * @{
 */
...
/**
 * Message DataLoggerBoard2 configuration tuple.
 */
#define MSG_DataLoggerBoard2                        0x1f0a007, 1, 8

/**
 * Message DataLoggerBoard2 id.
 */
#define ID_DataLoggerBoard2                         0x1f0a007

/**
 * Message DataLoggerBoard2 extended id bit.
 */
#define EXT_DataLoggerBoard2                        1

/**
 * Message DataLoggerBoard2 Data Length Count.
 */
#define DLC_DataLoggerBoard2                        8

/**
 * Message DataLoggerBoard2 cycle time.
 */
#define CYCLE_DataLoggerBoard2                      20

/**
 * Message DataLoggerBoard2 fast cycle time.
 */
#define FAST_DataLoggerBoard2                       0

/**
 * Initialise message DataLoggerBoard2 buffer.
 *
 * @param buf
 *	The can message buffer to initialise
 */
#define INIT_DataLoggerBoard2(buf) { \
	INITSIG_DataLoggerBoard2_WheelSpeed1(buf); \
	INITSIG_DataLoggerBoard2_WheelSpeed2(buf); \
	INITSIG_DataLoggerBoard2_BrakeTemp(buf); \
}
...
/**
 * @defgroup SIG_DataLoggerBoard1_BrakePressureRear Signal BrakePressureRear of Message DataLoggerBoard1 (0x1f0a006)
 *
 * Received by the ECUs:
 *
 * @ingroup MSG_DataLoggerBoard1
 * @{
 */

/**
 * Signal BrakePressureRear configuration tuple.
 *
 * @deprecated
 *	Use \ref SET_DataLoggerBoard1_BrakePressureRear and \ref GET_DataLoggerBoard1_BrakePressureRear instead.
 */
#define SIG_DataLoggerBoard1_BrakePressureRear        1, 0, 7, 10

/**
 * Signal BrakePressureRear setup tuple.
 *
 * @deprecated
 *	Use \ref INITSIG_DataLoggerBoard1_BrakePressureRear or \ref INIT_DataLoggerBoard1 instead.
 */
#define SETUP_DataLoggerBoard1_BrakePressureRear      1, 0, 7, 10, 0

/**
 * Get signal BrakePressureRear from buffer.
 *
 * @param buf
 ...
 *	The raw signal
 */
#define GET_DataLoggerBoard1_BrakePressureRear(buf) (0 \
	| (uword)(+(uword)((buf[0] >> 0) & 0xff) << 2) \
	| (ubyte)(+(ubyte)((buf[1] >> 6) & 0x03) << 0) \
)

/**
 * Set signal BrakePressureRear in buffer.
 *
 * @param buf
 ...
 */
#define SET_DataLoggerBoard1_BrakePressureRear(buf, val) { \
	buf[0] &= ~(0xff << 0); \
...
/**
 * Set signal BrakePressureRear in buffer to its initial value.
 *
 * @param buf
 *	The can message buffer to initialise
 */
#define INITSIG_DataLoggerBoard1_BrakePressureRear(buf) \
	SET_DataLoggerBoard1_BrakePressureRear(buf, 0)

/**
 * Signal BrakePressureRear value conversion with 16 bit factor and offset.
 *
 * @param x
 ...
 */
#define CALC_DataLoggerBoard1_BrakePressureRear(x, fmt) \
	((x) * fmt * 1000 / 1023)

/**
 * Signal BrakePressureRear raw initial value.
 */
#define START_DataLoggerBoard1_BrakePressureRear      0

/**
 * Signal BrakePressureRear raw minimum value.
 */
#define MIN_DataLoggerBoard1_BrakePressureRear        0

/**
 * Signal BrakePressureRear raw maximum value.
 */
#define MAX_DataLoggerBoard1_BrakePressureRear        1023

/**
 * Signal BrakePressureRear raw offset value.
 */
#define OFF_DataLoggerBoard1_BrakePressureRear        0
...
/**
 * @defgroup SIG_DataLoggerBoard1_BrakePressureFront Signal BrakePressureFront of Message DataLoggerBoard1 (0x1f0a006)
 *
 * Received by the ECUs:
 *
 * @ingroup MSG_DataLoggerBoard1
...
/**
 * Signal BrakePressureFront configuration tuple.
 *
 * @deprecated
 *	Use \ref SET_DataLoggerBoard1_BrakePressureFront and \ref GET_DataLoggerBoard1_BrakePressureFront instead.
 */
#define SIG_DataLoggerBoard1_BrakePressureFront        1, 0, 13, 10

/**
 * Signal BrakePressureFront setup tuple.
 *
 * @deprecated
 *	Use \ref INITSIG_DataLoggerBoard1_BrakePressureFront or \ref INIT_DataLoggerBoard1 instead.
 */
#define SETUP_DataLoggerBoard1_BrakePressureFront      1, 0, 13, 10, 0

/**
 * Get signal BrakePressureFront from buffer.
 *
 * @param buf
 *	The can message buffer containing the signal
 * @return
 *	The raw signal
 */
#define GET_DataLoggerBoard1_BrakePressureFront(buf) (0 \
	| (uword)(+(uword)((buf[1] >> 0) & 0x3f) << 4) \
	| (ubyte)(+(ubyte)((buf[2] >> 4) & 0x0f) << 0) \
)

/**
 * Set signal BrakePressureFront in buffer.
 *
 * @param buf
 *	The can message buffer to add the signal to
 * @param val
 *	The raw value to set the signal to
 */
#define SET_DataLoggerBoard1_BrakePressureFront(buf, val) { \
	buf[1] &= ~(0x3f << 0); \
...
/**
 * Set signal BrakePressureFront in buffer to its initial value.
 *
 * @param buf
 *	The can message buffer to initialise
 */
#define INITSIG_DataLoggerBoard1_BrakePressureFront(buf) \
	SET_DataLoggerBoard1_BrakePressureFront(buf, 0)

/**
 * Signal BrakePressureFront value conversion with 16 bit factor and offset.
 *
 * @param x
 *	The raw signal value
 * @param fmt
 ...
 *	The signal value as a human readable number
 */
#define CALC_DataLoggerBoard1_BrakePressureFront(x, fmt) \
	((x) * fmt * 1000 / 1023)

/**
 * Signal BrakePressureFront raw initial value.
 */
#define START_DataLoggerBoard1_BrakePressureFront      0

/**
 * Signal BrakePressureFront raw minimum value.
 */
#define MIN_DataLoggerBoard1_BrakePressureFront        0

/**
 * Signal BrakePressureFront raw maximum value.
 */
#define MAX_DataLoggerBoard1_BrakePressureFront        1023

/**
 * Signal BrakePressureFront raw offset value.
 */
#define OFF_DataLoggerBoard1_BrakePressureFront        0
...
/**
 * @defgroup SIG_DataLoggerBoard1_CGGyroscope Signal CGGyroscope of Message DataLoggerBoard1 (0x1f0a006)
 *
 * Received by the ECUs:
 *
 * @ingroup MSG_DataLoggerBoard1
 ...
 *
 * @deprecated
 *	Use \ref SET_DataLoggerBoard1_CGGyroscope and \ref GET_DataLoggerBoard1_CGGyroscope instead.
 */
#define SIG_DataLoggerBoard1_CGGyroscope            1, 0, 19, 10

/**
 * Signal CGGyroscope setup tuple.
 *
 * @deprecated
 *	Use \ref INITSIG_DataLoggerBoard1_CGGyroscope or \ref INIT_DataLoggerBoard1 instead.
 */
#define SETUP_DataLoggerBoard1_CGGyroscope          1, 0, 19, 10, 0
 ...
 *	The raw signal
 */
#define GET_DataLoggerBoard1_CGGyroscope(buf) (0 \
 ...
 *	The raw value to set the signal to
 */
#define SET_DataLoggerBoard1_CGGyroscope(buf, val) { \
	buf[2] &= ~(0x0f << 0); \
 ...
 *	The can message buffer to initialise
 */
#define INITSIG_DataLoggerBoard1_CGGyroscope(buf) \
	SET_DataLoggerBoard1_CGGyroscope(buf, 0)
 ...
 *	The signal value as a human readable number
 */
#define CALC_DataLoggerBoard1_CGGyroscope(x, fmt) \
	((x) * fmt * 1999 / 16384 + fmt * 32768 / (-518))

/**
 * Signal CGGyroscope raw initial value.
 */
#define START_DataLoggerBoard1_CGGyroscope          0

/**
 * Signal CGGyroscope raw minimum value.
 */
#define MIN_DataLoggerBoard1_CGGyroscope            108

/**
 * Signal CGGyroscope raw maximum value.
 */
#define MAX_DataLoggerBoard1_CGGyroscope            927

/**
 * Signal CGGyroscope raw offset value.
 */
#define OFF_DataLoggerBoard1_CGGyroscope            -518
...
/**
 * @defgroup SIG_DataLoggerBoard1_CGAccelRawX Signal CGAccelRawX of Message DataLoggerBoard1 (0x1f0a006)
 *
 * Received by the ECUs:
 *
 * @ingroup MSG_DataLoggerBoard1
 ...
 *
 * @deprecated
 *	Use \ref SET_DataLoggerBoard1_CGAccelRawX and \ref GET_DataLoggerBoard1_CGAccelRawX instead.
 */
#define SIG_DataLoggerBoard1_CGAccelRawX            1, 0, 25, 10

/**
 * Signal CGAccelRawX setup tuple.
 *
 * @deprecated
 *	Use \ref INITSIG_DataLoggerBoard1_CGAccelRawX or \ref INIT_DataLoggerBoard1 instead.
 */
#define SETUP_DataLoggerBoard1_CGAccelRawX          1, 0, 25, 10, 0
 ...
 *	The raw signal
 */
#define GET_DataLoggerBoard1_CGAccelRawX(buf) (0 \
 ...
 *	The raw value to set the signal to
 */
#define SET_DataLoggerBoard1_CGAccelRawX(buf, val) { \
	buf[3] &= ~(0x03 << 0); \
 ...
 *	The can message buffer to initialise
 */
#define INITSIG_DataLoggerBoard1_CGAccelRawX(buf) \
	SET_DataLoggerBoard1_CGAccelRawX(buf, 0)
 ...
 *	The signal value as a human readable number
 */
#define CALC_DataLoggerBoard1_CGAccelRawX(x, fmt) \
	((x) * fmt * 25 / 2048 + fmt * 4096 / (-659))

/**
 * Signal CGAccelRawX raw initial value.
 */
#define START_DataLoggerBoard1_CGAccelRawX          0

/**
 * Signal CGAccelRawX raw minimum value.
 */
#define MIN_DataLoggerBoard1_CGAccelRawX            99

/**
 * Signal CGAccelRawX raw maximum value.
 */
#define MAX_DataLoggerBoard1_CGAccelRawX            918

/**
 * Signal CGAccelRawX raw offset value.
 */
#define OFF_DataLoggerBoard1_CGAccelRawX            -509
...
/**
 * @defgroup SIG_DataLoggerBoard1_CGAccelRawY Signal CGAccelRawY of Message DataLoggerBoard1 (0x1f0a006)
 *
 * Received by the ECUs:
 *
 * @ingroup MSG_DataLoggerBoard1
 ...
 *
 * @deprecated
 *	Use \ref SET_DataLoggerBoard1_CGAccelRawY and \ref GET_DataLoggerBoard1_CGAccelRawY instead.
 */
#define SIG_DataLoggerBoard1_CGAccelRawY            1, 0, 47, 10

/**
 * Signal CGAccelRawY setup tuple.
 *
 * @deprecated
 *	Use \ref INITSIG_DataLoggerBoard1_CGAccelRawY or \ref INIT_DataLoggerBoard1 instead.
 */
#define SETUP_DataLoggerBoard1_CGAccelRawY          1, 0, 47, 10, 0
 ...
 *	The raw signal
 */
#define GET_DataLoggerBoard1_CGAccelRawY(buf) (0 \
 ...
 *	The raw value to set the signal to
 */
#define SET_DataLoggerBoard1_CGAccelRawY(buf, val) { \
	buf[5] &= ~(0xff << 0); \
 ...
 *	The can message buffer to initialise
 */
#define INITSIG_DataLoggerBoard1_CGAccelRawY(buf) \
	SET_DataLoggerBoard1_CGAccelRawY(buf, 0)
 ...
 *	The signal value as a human readable number
 */
#define CALC_DataLoggerBoard1_CGAccelRawY(x, fmt) \
	((x) * fmt * 25 / 2048 + fmt * 4096 / (-659))

/**
 * Signal CGAccelRawY raw initial value.
 */
#define START_DataLoggerBoard1_CGAccelRawY          0

/**
 * Signal CGAccelRawY raw minimum value.
 */
#define MIN_DataLoggerBoard1_CGAccelRawY            99

/**
 * Signal CGAccelRawY raw maximum value.
 */
#define MAX_DataLoggerBoard1_CGAccelRawY            918

/**
 * Signal CGAccelRawY raw offset value.
 */
#define OFF_DataLoggerBoard1_CGAccelRawY            -509
...
/**
 * @defgroup SIG_DataLoggerBoard1_CGAccelRawZ Signal CGAccelRawZ of Message DataLoggerBoard1 (0x1f0a006)
 *
 * Received by the ECUs:
 *
 * @ingroup MSG_DataLoggerBoard1
 ...
 *
 * @deprecated
 *	Use \ref SET_DataLoggerBoard1_CGAccelRawZ and \ref GET_DataLoggerBoard1_CGAccelRawZ instead.
 */
#define SIG_DataLoggerBoard1_CGAccelRawZ            1, 0, 53, 10

/**
 * Signal CGAccelRawZ setup tuple.
 *
 * @deprecated
 *	Use \ref INITSIG_DataLoggerBoard1_CGAccelRawZ or \ref INIT_DataLoggerBoard1 instead.
 */
#define SETUP_DataLoggerBoard1_CGAccelRawZ          1, 0, 53, 10, 0
 ...
 *	The raw signal
 */
#define GET_DataLoggerBoard1_CGAccelRawZ(buf) (0 \
 ...
 *	The raw value to set the signal to
 */
#define SET_DataLoggerBoard1_CGAccelRawZ(buf, val) { \
	buf[6] &= ~(0x3f << 0); \
 ...
 *	The can message buffer to initialise
 */
#define INITSIG_DataLoggerBoard1_CGAccelRawZ(buf) \
	SET_DataLoggerBoard1_CGAccelRawZ(buf, 0)
 ...
 *	The signal value as a human readable number
 */
#define CALC_DataLoggerBoard1_CGAccelRawZ(x, fmt) \
	((x) * fmt * 25 / 2048 + fmt * 4096 / (-659))

/**
 * Signal CGAccelRawZ raw initial value.
 */
#define START_DataLoggerBoard1_CGAccelRawZ          0

/**
 * Signal CGAccelRawZ raw minimum value.
 */
#define MIN_DataLoggerBoard1_CGAccelRawZ            99

/**
 * Signal CGAccelRawZ raw maximum value.
 */
#define MAX_DataLoggerBoard1_CGAccelRawZ            918

/**
 * Signal CGAccelRawZ raw offset value.
 */
#define OFF_DataLoggerBoard1_CGAccelRawZ            -509
...
/**
 * @defgroup SIG_DataLoggerBoard2_WheelSpeed1 Signal WheelSpeed1 of Message DataLoggerBoard2 (0x1f0a007)
 *
 * Received by the ECUs:
 *
 * @ingroup MSG_DataLoggerBoard2
 * @{
 */

/**
 * Signal WheelSpeed1 configuration tuple.
 *
 * @deprecated
 *	Use \ref SET_DataLoggerBoard2_WheelSpeed1 and \ref GET_DataLoggerBoard2_WheelSpeed1 instead.
 */
#define SIG_DataLoggerBoard2_WheelSpeed1            1, 0, 7, 16

/**
 * Signal WheelSpeed1 setup tuple.
 *
 * @deprecated
 *	Use \ref INITSIG_DataLoggerBoard2_WheelSpeed1 or \ref INIT_DataLoggerBoard2 instead.
 */
#define SETUP_DataLoggerBoard2_WheelSpeed1          1, 0, 7, 16, 0

/**
 * Get signal WheelSpeed1 from buffer.
 *
 * @param buf
 *	The can message buffer containing the signal
 * @return
 *	The raw signal
 */
#define GET_DataLoggerBoard2_WheelSpeed1(buf) (0 \
	| (uword)(+(uword)((buf[0] >> 0) & 0xff) << 8) \
	| (ubyte)(+(ubyte)((buf[1] >> 0) & 0xff) << 0) \
)

/**
 * Set signal WheelSpeed1 in buffer.
 *
 * @param buf
 *	The can message buffer to add the signal to
 * @param val
 *	The raw value to set the signal to
 */
#define SET_DataLoggerBoard2_WheelSpeed1(buf, val) { \
	buf[0] &= ~(0xff << 0); \
...
/**
 * Set signal WheelSpeed1 in buffer to its initial value.
 *
 * @param buf
 *	The can message buffer to initialise
 */
#define INITSIG_DataLoggerBoard2_WheelSpeed1(buf) \
	SET_DataLoggerBoard2_WheelSpeed1(buf, 0)

/**
 * Signal WheelSpeed1 value conversion with 16 bit factor and offset.
 *
 * @param x
 *	The raw signal value
 * @param fmt
 ...
 *	The signal value as a human readable number
 */
#define CALC_DataLoggerBoard2_WheelSpeed1(x, fmt) \
	((x) * fmt)

/**
 * Signal WheelSpeed1 raw initial value.
 */
#define START_DataLoggerBoard2_WheelSpeed1          0

/**
 * Signal WheelSpeed1 raw minimum value.
 */
#define MIN_DataLoggerBoard2_WheelSpeed1            0

/**
 * Signal WheelSpeed1 raw maximum value.
 */
#define MAX_DataLoggerBoard2_WheelSpeed1            65535

/**
 * Signal WheelSpeed1 raw offset value.
 */
#define OFF_DataLoggerBoard2_WheelSpeed1            0
...
/**
 * @defgroup SIG_DataLoggerBoard2_WheelSpeed2 Signal WheelSpeed2 of Message DataLoggerBoard2 (0x1f0a007)
 *
 * Received by the ECUs:
 *
 * @ingroup MSG_DataLoggerBoard2
...
/**
 * Signal WheelSpeed2 configuration tuple.
 *
 * @deprecated
 *	Use \ref SET_DataLoggerBoard2_WheelSpeed2 and \ref GET_DataLoggerBoard2_WheelSpeed2 instead.
 */
#define SIG_DataLoggerBoard2_WheelSpeed2            1, 0, 23, 16

/**
 * Signal WheelSpeed2 setup tuple.
 *
 * @deprecated
 *	Use \ref INITSIG_DataLoggerBoard2_WheelSpeed2 or \ref INIT_DataLoggerBoard2 instead.
 */
#define SETUP_DataLoggerBoard2_WheelSpeed2          1, 0, 23, 16, 0

/**
 * Get signal WheelSpeed2 from buffer.
 *
 * @param buf
 *	The can message buffer containing the signal
 * @return
 *	The raw signal
 */
#define GET_DataLoggerBoard2_WheelSpeed2(buf) (0 \
	| (uword)(+(uword)((buf[2] >> 0) & 0xff) << 8) \
	| (ubyte)(+(ubyte)((buf[3] >> 0) & 0xff) << 0) \
)

/**
 * Set signal WheelSpeed2 in buffer.
 *
 * @param buf
 *	The can message buffer to add the signal to
 * @param val
 *	The raw value to set the signal to
 */
#define SET_DataLoggerBoard2_WheelSpeed2(buf, val) { \
	buf[2] &= ~(0xff << 0); \
...
/**
 * Set signal WheelSpeed2 in buffer to its initial value.
 *
 * @param buf
 *	The can message buffer to initialise
 */
#define INITSIG_DataLoggerBoard2_WheelSpeed2(buf) \
	SET_DataLoggerBoard2_WheelSpeed2(buf, 0)

/**
 * Signal WheelSpeed2 value conversion with 16 bit factor and offset.
 *
 * @param x
 *	The raw signal value
 * @param fmt
 ...
 *	The signal value as a human readable number
 */
#define CALC_DataLoggerBoard2_WheelSpeed2(x, fmt) \
	((x) * fmt)

/**
 * Signal WheelSpeed2 raw initial value.
 */
#define START_DataLoggerBoard2_WheelSpeed2          0

/**
 * Signal WheelSpeed2 raw minimum value.
 */
#define MIN_DataLoggerBoard2_WheelSpeed2            0

/**
 * Signal WheelSpeed2 raw maximum value.
 */
#define MAX_DataLoggerBoard2_WheelSpeed2            65535

/**
 * Signal WheelSpeed2 raw offset value.
 */
#define OFF_DataLoggerBoard2_WheelSpeed2            0
...
/**
 * @defgroup SIG_DataLoggerBoard2_BrakeTemp Signal BrakeTemp of Message DataLoggerBoard2 (0x1f0a007)
 *
 * Received by the ECUs:
 *
 * @ingroup MSG_DataLoggerBoard2
...
/**
 * Signal BrakeTemp configuration tuple.
 *
 * @deprecated
 *	Use \ref SET_DataLoggerBoard2_BrakeTemp and \ref GET_DataLoggerBoard2_BrakeTemp instead.
 */
#define SIG_DataLoggerBoard2_BrakeTemp              1, 0, 39, 10

/**
 * Signal BrakeTemp setup tuple.
 *
 * @deprecated
 *	Use \ref INITSIG_DataLoggerBoard2_BrakeTemp or \ref INIT_DataLoggerBoard2 instead.
 */
#define SETUP_DataLoggerBoard2_BrakeTemp            1, 0, 39, 10, 0

/**
 * Get signal BrakeTemp from buffer.
 *
 * @param buf
 *	The can message buffer containing the signal
 * @return
 *	The raw signal
 */
#define GET_DataLoggerBoard2_BrakeTemp(buf) (0 \
	| (uword)(+(uword)((buf[4] >> 0) & 0xff) << 2) \
	| (ubyte)(+(ubyte)((buf[5] >> 6) & 0x03) << 0) \
)

/**
 * Set signal BrakeTemp in buffer.
 *
 * @param buf
 *	The can message buffer to add the signal to
 * @param val
 *	The raw value to set the signal to
 */
#define SET_DataLoggerBoard2_BrakeTemp(buf, val) { \
	buf[4] &= ~(0xff << 0); \
...
/**
 * Set signal BrakeTemp in buffer to its initial value.
 *
 * @param buf
 *	The can message buffer to initialise
 */
#define INITSIG_DataLoggerBoard2_BrakeTemp(buf) \
	SET_DataLoggerBoard2_BrakeTemp(buf, 0)

/**
 * Signal BrakeTemp value conversion with 16 bit factor and offset.
 *
 * @param x
 *	The raw signal value
 * @param fmt
 ...
 *	The signal value as a human readable number
 */
#define CALC_DataLoggerBoard2_BrakeTemp(x, fmt) \
	((x) * fmt)

/**
 * Signal BrakeTemp raw initial value.
 */
#define START_DataLoggerBoard2_BrakeTemp            0

/**
 * Signal BrakeTemp raw minimum value.
 */
#define MIN_DataLoggerBoard2_BrakeTemp              0

/**
 * Signal BrakeTemp raw maximum value.
 */
#define MAX_DataLoggerBoard2_BrakeTemp              1023

/**
 * Signal BrakeTemp raw offset value.
 */
#define OFF_DataLoggerBoard2_BrakeTemp              0
