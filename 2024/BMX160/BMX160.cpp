...
// Description: This is an adaptation of Fary's https://github.com/DFRobot/DFRobot_BMX160.

#include "BMX160.h"

BMX160::BMX160(TwoWire *pWire)
{
    _pWire = pWire;
...
int8_t BMX160::_softReset(sBmx160Dev_t *dev)
{
    int8_t rslt = BMX160_OK;
...
void BMX160::defaultParamSettg(sBmx160Dev_t *dev)
{
...
void BMX160::getAllData(sBmx160SensorData_t *magn, sBmx160SensorData_t *gyro, sBmx160SensorData_t *accel)
{
