...
void setup()
{
  ...
  sensor.VL6180x_setRegister(VL6180X_SYSRANGE_PART_TO_PART_RANGE_OFFSET, off);
...
//  distances[counter%10] = sensor.getDistance();



  Serial.println(millis());
  S = sensor.getDistance();
  Serial.println(millis());
  I = S-xn;
  xnplus = xn + K * I;
//  Serial.println(xnplus);
  xn = xnplus;
...
//  Serial.println(distance[counter%10]);
